...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=bfp842esd-s-param-input-output-match-l2_VCE_2_5_V_IC_4_0mA.dat>
  <DataDisplay=bfp842esd-s-param-input-output-match-l2_VCE_2_5_V_IC_4_0mA.dpl>
  <OpenDisplay=1>
  <Script=bfp842esd-s-param-input-output-match-l2_VCE_2_5_V_IC_4_0mA.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <L L3 1 730 220 -26 10 0 0 "6.71 nH" 1 "" 0>
  <GND *2 5 680 340 0 0 0 0>
  <L L2 1 680 290 10 -26 0 1 "24.3 nH" 1 "" 0>
  <C C2 1 870 220 -26 17 0 0 "100 nF" 1 "" 0 "neutral" 0>
