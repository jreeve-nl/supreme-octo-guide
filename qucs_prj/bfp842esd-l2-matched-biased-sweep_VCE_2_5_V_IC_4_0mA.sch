...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=bfp842esd-s-param-l2-matched-biased-sweep_VCE_2_5_V_IC_4_0mA.dat>
  <DataDisplay=bfp842esd-s-param-l2-matched-biased-sweep_VCE_2_5_V_IC_4_0mA.dpl>
  <OpenDisplay=1>
  <Script=bfp842esd-s-param-l2-matched-biased-sweep_VCE_2_5_V_IC_4_0mA.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <R R10 1 960 270 15 -26 0 1 "160 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
  <C C4 1 750 -20 -26 17 0 0 "18 pF" 1 "" 0 "neutral" 0>
...
<Paintings>
  ...
  <Text 840 -190 12 #000000 0 "3V supply">
  <Text 1153 282 12 #000000 0 "Port 1">
</Paintings>
