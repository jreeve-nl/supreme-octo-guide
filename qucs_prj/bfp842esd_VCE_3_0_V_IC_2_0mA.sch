...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=bfp842esd-s-param.dat>
  <DataDisplay=bfp842esd-s-param.dpl>
  <OpenDisplay=1>
  <Script=bfp842esd-s-param.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <SPfile X1 1 610 220 -26 -59 0 0 "../s2p/BFP842ESD_w_noise_VCE_3.0V_IC_2.0mA.s2p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
</Components>
<Wires>
