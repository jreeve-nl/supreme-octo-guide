...
<Properties>
  <View=0,-60,1429,875,1,0,60>
  <Grid=10,10,1>
  <DataSet=bfp842esd-s-param-l2-2-matched-sweep-stability_VCE_2_5_V_IC_4_0mA.dat>
  <DataDisplay=bfp842esd-s-param-l2-2-matched-sweep-stability_VCE_2_5_V_IC_4_0mA.dpl>
  <OpenDisplay=1>
  <Script=bfp842esd-s-param-l2-2-matched-sweep-stability_VCE_2_5_V_IC_4_0mA.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <L L1 1 540 270 10 -26 0 1 "8.39 nH" 1 "" 0>
  <Pac P2 1 960 270 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 GHz" 0 "26.85" 0>
  <GND * 5 960 340 0 0 0 0>
  <GND *2 5 680 340 0 0 0 0>
  <L L2 1 680 290 10 -26 0 1 "4.836 nH" 1 "" 0>
  <C C1 1 470 220 -20 -53 0 2 "1.26 pF" 1 "" 0 "neutral" 0>
  <C C2 1 790 220 -26 17 0 0 "1.680 pF" 1 "" 0 "neutral" 0>
  <Eqn Eqn1 1 600 500 -31 15 0 0 "S21=S[2,1]" 1 "S11=S[1,1]" 1 "S11dB=dB(mag(S11))" 1 "S21dB=dB(mag(S21))" 1 "yes" 0>
