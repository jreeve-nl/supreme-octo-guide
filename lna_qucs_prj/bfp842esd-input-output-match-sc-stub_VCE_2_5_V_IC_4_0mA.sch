...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=bfp842esd-input-output-match-sc-stub_VCE_2_5_V_IC_4_0mA.dat>
  <DataDisplay=bfp842esd-input-output-match-sc-stub_VCE_2_5_V_IC_4_0mA.dpl>
  <OpenDisplay=1>
  <Script=bfp842esd-input-output-match-sc-stub_VCE_2_5_V_IC_4_0mA.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
